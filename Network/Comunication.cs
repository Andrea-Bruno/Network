...
namespace NetworkManager
{
	...
	public class Communication
	{
		...
		public BaseWebReader SendObjectAsync(ref object obj, string webAddress = null, NameValueCollection form = null, string toUser = null, int secTimeOut = 0, int secWaitAnswer = 0, OnReceivedObject executeOnReceivedObject = null, Action executeIfNoAnswer = null, bool cancelAllMyRequest = false, bool removeObjectsToMe = false, bool removeMyObjects = false)
		{
			return ExecuteServerRequest(true, webAddress, null, obj, form, executeOnReceivedObject, secWaitAnswer, executeIfNoAnswer, secTimeOut, toUser, cancelAllMyRequest, removeObjectsToMe, removeMyObjects);
		}

		public string GetObjectSync(string webAddress = null, string request = null, object obj = null, string toUser = null, int secWaitAnswer = 0, Action executeIfNoAnswer = null, bool cancelAllMyRequest = false, bool removeObjectsToMe = false, bool removeMyObjects = false)
		{
			var reader = ExecuteServerRequest(false, webAddress, request, obj, null, null, secWaitAnswer, executeIfNoAnswer, 0, toUser, cancelAllMyRequest, removeObjectsToMe, removeMyObjects);
			return reader.Html;
		}

		public BaseWebReader GetObjectAsync(OnReceivedObject executeOnReceivedObject, string webAddress = null, string request = null, object obj = null, string toUser = null, int secWaitAnswer = 0, Action executeIfNoAnswer = null, bool cancelAllMyRequest = false, bool removeObjectsToMe = false, bool removeMyObjects = false)
		{
		...
		private class WebReader : BaseWebReader
		{
			...
			public WebReader(bool async, string url, Action<string> parser, Action elapse, NameValueCollection form, int secTimeout = 0, Action executeAtTimeout = null) : base(parser, elapse, form, secTimeout, executeAtTimeout)
			{
				...
				Upload = () =>
				{
					var responseBytes = WebClient.UploadValues(url, "POST", form ?? new NameValueCollection());
		...
		private class VirtualWebClient
		{
			...
			public void UploadValuesAsync(string address, string method, NameValueCollection form, VirtualDevice client) => new Thread(() => Result = UploadValues(address, method, form, client)).Start();
