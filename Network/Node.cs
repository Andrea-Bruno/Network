...
namespace NetworkManager
{
	...
	{
		public Node() { }
		public Node((string Address, string MachineName) point)
		{
	...
	{
		/// <summary>
		/// Create the configuration of this node by passing the private key and the address for connection from outside
		/// </summary>
		/// <param name="privateKey">The private key used for encryption and digital signatures</param>
		/// <param name="address">The address with which the machine can be reached from the outside</param>
